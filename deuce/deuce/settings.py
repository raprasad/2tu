# Django settings for deuce project.
import os
...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(DEUCE_PROJECT_DIR, 'test_db', 'db01.db' ),                      # Or path to database file if using sqlite3.
...
SECRET_KEY = 'd3-8ep4x!69&amp;(zcyu0qvfebn*gi7a8*mut3b+cgj=9em+z+6i+'
